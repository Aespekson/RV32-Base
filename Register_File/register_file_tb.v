...
module register_file_tb;
  ...
  reg [$clog2(`NUM_REGISTER)-1:0] rd_addr = 5'b00000;
...
register_file dut (
  ...
  @(negedge clk)
    we = 1'b1;// rd_addr does not change independently of rd, so there should be no danger of keeping write enabled until the end.
    rd_addr = 5'b00001;
    rd = 2;
  @(negedge clk)
    rd_addr = 5'b00010;
